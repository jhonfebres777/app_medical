            ...
            <div class="data-card shadow">
                <div class="data-card-header">
                    <div class="card-header-actions">
                        <h4 class="data-card-title">Historial clinico </h4>
                        <a href="{{ url('admin/historial/create') }}" class="btn btn-primary">
                            <i class="fas fa-plus-circle mr-1"></i> Registrar nuevo Historial
                        </a>
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach ($historiales as $index => $historial)
                                <tr>
                                    ...
                                    <td>{{ $historial->user->email }}</td>
                                    <td style="text-align: center;">
                                        <div class="action-buttons">
                                            <a href="{{ url('admin/historial/'.$historial->id) }}" class="btn btn-info btn-sm" title="Ver">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ url('admin/historial/' . $historial->id . '/edit') }}" class="btn btn-warning btn-sm" title="Editar">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{{ url('admin/historial/' . $historial->id . '/confirm-delete') }}" class="btn btn-danger btn-sm" title="Eliminar">
    ...
    $(function () {
        $("#secretarias-table").DataTable({
            ...
            "language": {
                ...
                "infoFiltered": "(filtrado de _MAX_ historiales en total)",
                "infoPostFix": "",
                "thousands": ",",
