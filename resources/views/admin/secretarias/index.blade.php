            ...
            <div class="data-card shadow">
                <div class="data-card-header">
                    <div class="card-header-actions">
                        <h4 class="data-card-title">LISTADO DE SECRETARIAS</h4>
                        <a href="{{ url('admin/secretarias/create') }}" class="btn btn-primary">
                            <i class="fas fa-plus-circle mr-1"></i> Registrar nueva secretaria
                        </a>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="{{ url('admin/secretarias/'.$secretaria->id) }}" class="btn btn-info btn-sm">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ url('admin/secretarias/' . $secretaria->id . '/edit') }}" class="btn btn-warning btn-sm">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{{ url('admin/secretarias/' . $secretaria->id . '/confirm-delete') }}" class="btn btn-danger btn-sm">
    ...
    $(function () {
        $("#secretarias-table").DataTable({
            ...
            "language": {
                ...
                "infoFiltered": "(filtrado de _MAX_ secretarias en total)",
                "infoPostFix": "",
                "thousands": ",",
