        ...
        <div class="col-md-8">
            <div class="card shadow card-outline card-danger">
                <div class="card-header bg-danger text-white d-flex align-items-center">
                    <h4 class="mb-0 ms-2">Eliminar este Registro  |{{  $usuario->name  }}</h4>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <div class="form-control-plaintext fs-5">{{ $usuario->name }}</div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label"><strong>Email:</strong></label>
                                <div class="form-control-plaintext fs-5">{{ $usuario->email }}</div>
                            </div>
                        </div>
                    </div>
