            ...
            <div class="data-card shadow">
                <div class="data-card-header">
                    <div class="card-header-actions">
                        <h4 class="data-card-title">LISTADO DE USUARIOS</h4>
                        <a href="{{ url('admin/secretarias/create') }}" class="btn btn-primary">
                            <i class="fas fa-plus-circle mr-1"></i> Registrar nuevo usuario
                        </a>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <a href="{{ url('admin/usuarios/' . $usuario->id . '/edit') }}" class="btn btn-warning btn-sm">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{{ url('admin/usuarios/' . $usuario->id . '/confirm-delete') }}" class="btn btn-danger btn-sm">
